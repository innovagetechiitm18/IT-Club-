  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto space-y-6">
        <div
          ref={badgeRef}
          className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-amber-500/20 bg-amber-500/5 backdrop-blur-sm"
        >
        ...
        >
          ...
          battlegrounds. Pick your arena — registration opens soon.
        </p>
      </div>
    </div>
  );
